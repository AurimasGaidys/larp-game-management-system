...
export const ItemHeader = () => {
  return (
    <div className="relative flex flex-col items-start p-[10px] h-[347px]">
      <div className="absolute left-[8px] z-30 ">
        <div className="h-[65px]"></div>
        <div className="z-30 bg-no-repeat h-[26px] w-[234px] bg-[url('/kd/rules_title.png')] bg-contain flex items-center justify-center"></div>
