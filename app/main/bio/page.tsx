        ...
        <div>
              ...
              <div className="flex flex-col flex-1 py-5 pl-5 overflow-hidden justify-center">
                ...
                <div className="flex flex-wrap justify-center">
                  <div className="flex justify-center w-full">
                    <div className="relative">
                      <div className="dark:shadow-xl border-gray-500 rounded-full align-middle border-8 max-w-[150px]">
                        <div className=" bg-no-repeat w-[150px] h-[150px] bg-[url('/512.jpeg')] bg-contain"></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="flex flex-wrap justify-center">
                  <div className="flex justify-center w-full">
                    <div className="relative">
                      <div className="dark:shadow-xl border-gray-500 rounded-full align-middle border-8 max-w-[150px]">
                        <div className=" bg-no-repeat w-[150px] h-[150px] bg-[url('/256.jpeg')] bg-contain"></div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-5 p-5 bg-white dark:bg-gray-800  rounded-lg shadow">
            <div className="px-5 pb-5 space-y-5">
              <h2 className="inline text-2xl font-semibold leading-none text-center pb-5">
                Known Locations
              </h2>
              <div className="space-y-5">
                <div>
                  ...
                  <div className="flex items-center">
                    <video
                      className="dark:shadow-xl border-white dark:border-gray-800 rounded-full align-middle border-8 max-w-[80px]"
                      autoPlay
                      muted
                    >
                      <source
                        src={
                          "https://firebasestorage.googleapis.com/v0/b/dvidlis.appspot.com/o/playerIcon%2F40938050158.mp4?alt=media&token=1a015511-bbe4-4733-b460-c474c1ff8a2e&quot"
                        }
                        type="video/mp4"
                      />
                    </video>
                    <p>
                      Influenceris. Realybes show Zvaigzde ir begemotas
                      nugaletojas
                    </p>
                  </div>
                </div>
            ...
            <div className="px-5 pb-5 space-y-5">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <div className="flex items-center">
                    <img
                      src="https://media.takealot.com/covers_tsins/68689778/68689778-1-pdpxl.jpeg"
                      className="dark:shadow-xl border-white dark:border-gray-800 rounded-full align-middle border-8 max-w-[80px]"
                    />
                    <p>
                      Is karto tampi daug itikimesnis Sakyciau + 5 charizmos
                    </p>
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex items-center">
                    <img
                      src="https://images.gamebanana.com/img/ico/sprays/5f804891da197.png"
                      className="dark:shadow-xl border-white dark:border-gray-800 rounded-full align-middle border-8 max-w-[80px]"
                    />
