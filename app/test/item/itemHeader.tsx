...
export const ItemHeader = ({ name }: LeadListProps) => {
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative -mt-[40px] h-[419px] w-[315px] bg-no-repeat bg-contain flex p-2 flex justify-center items-center z-5">
      <div className="absolute h-[419px] w-[315px] bg-no-repeat bg-[url('/kd/bag.png')] bg-contain flex p-2 flex justify-center items-center z-5"></div>
