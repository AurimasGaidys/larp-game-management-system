...
export const ItemContent = ({ name }: LeadListProps) => {
  return (
    <div className="flex flex-col items-center -mt-[44px]">
      ...
      <div className="absolute left-[50%] top-[230px] h-[704px] w-[519px] -translate-x-[50%]  bgh-center bg-no-repeat h-[389px] w-[582px] bg-[url('/kd/items/bg_paper.png')] bg-contain"></div>
